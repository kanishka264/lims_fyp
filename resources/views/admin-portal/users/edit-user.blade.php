            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Update User Data</h4>
                                ...
                                <form id="register_form">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="inputEmail4" name="first_name" value="<?php echo $userData->first_name ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="inputPassword4" class="form-label">Last Name</label>
                                            <input type="text" class="form-control" id="inputPassword4" name="last_name" value="<?php echo $userData->last_name ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="inputPassword4" name="mobile" value="<?php echo $userData->mobile ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="inputEmail4" class="form-label">Password <small>Keep this empty if you don't want to change password</small></label>
        ...
        $.ajax({
            ...
            success: function(msg) {
                ...
                if (msg[0].response_code == 200) {
                    ...
                    setTimeout(function() {
                        location.href = "receptionist-list";
                    }, 1500);
